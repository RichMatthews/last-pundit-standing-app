        ...
        <View>
          {userLeagues.loading ? (
            ...
            userLeagues.leagues.map((league: LeagueState) => (
              <TouchableOpacity onPress={() => navigation.push('League', { leagueId: league.id })} key={league.id}>
                <View style={leagueButton}>
                  <View>
                    <Text style={leagueTitle}>{league.name}</Text>
                    <View style={imageWrapper}>
                      <Image source={require('../../images/other/premier-league.png')} style={leagueImage} />
                    </View>
                  </View>
